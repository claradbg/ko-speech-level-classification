...
model = BertForSequenceClassification.from_pretrained("kobert_saved_model")
tokenizer = KoBERTTokenizer.from_pretrained("kobert_saved_model")
...
# If your test set was morphed before, apply the same again
...
# Prepare dataset
# test_dataset = Dataset.from_pandas(test_df[["text_morphed", "label"]])
...
with open("kobert_confusion_matrices.txt", "w", encoding="utf-8") as f:
